...
`\\Servant\data\Games\EscapeFromTarkov4\CURSORAIMODING\releases\ClearlyPrepareScreenAddon_(client_only)_v1.1.2_2026-06-27.zip`

```powershell
gh release create v1.1.2 "\\Servant\data\Games\EscapeFromTarkov4\CURSORAIMODING\releases\ClearlyPrepareScreenAddon_(client_only)_v1.1.2_2026-06-27.zip" ^
